...
Nas instruções que se seguem é assumido que os alunos estão familiarizados com as operações básicas no ambiente de virtualização (criar VMs; tipos de redes - _bridge_, _host-only_ e NAT; configuração básica das VMs, etc.)
